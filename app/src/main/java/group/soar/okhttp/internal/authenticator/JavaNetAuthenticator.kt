 ...
 */
package group.soar.okhttp.internal.authenticator
...
import group.soar.okhttp.Credentials
import group.soar.okhttp.Dns
...
/**
 * Adapts [Authenticator] to [okhttp.Authenticator]. Configure OkHttp to use [Authenticator] with
 * [okhttp.OkHttpClient.Builder.authenticator] or [okhttp.OkHttpClient.Builder.proxyAuthenticator].
 */
class JavaNetAuthenticator(private val defaultDns: Dns = Dns.SYSTEM) : group.soar.okhttp.Authenticator {
